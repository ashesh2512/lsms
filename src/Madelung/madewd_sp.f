...
c     cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      subroutine madewd_sp(lastrs,lastkn,myatom,num_atoms,alat,
...
c
      ...
      real*4     rslat_x(lastrs)
      real*4     rslat_y(lastrs)
      real*4     rslat_z(lastrs)
...
c        -------------------------------------------------------------
         call madsum_sp(lastkn,lastrs,ibegin,aij,
