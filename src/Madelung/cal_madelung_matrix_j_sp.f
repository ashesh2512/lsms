...
c     cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      subroutine cal_madelung_matrix_j_sp(mynod,num_atoms,
...
c
      character  istop*32
      character  sname*32
      parameter (sname='cal_madelung_matrix_sp')
c
      integer    mynod
      integer    num_atoms
c
...
c
      ...
      complex*8 madmatj(ndlmv,num_atoms)
c
      real*4     a0
      real*4     dmin
      real*4     dmin2
...
c
!      call getclm_sp(lmax,clm)
! meis: changed to normalized associated Legendre functions
      call ylm_coefficients_sp(lmax,clm)
      call lmfacts_sp(lmax,ndlj,ndlm,lofj,mofj,lofk,mofk)
...
c     ----------------------------------------------------------------
      ...
      call getstruc_sp(mynod,bravais_lattice_in,omegbra,etainv,
     >              iprslat_mad,ipknlat_mad,
     >              rslat_x,rslat_y,rslat_z,rslatsq,nrslat,
     >              knlat_x,knlat_y,knlat_z,knlatsq,nknlat,
     >              iprint,istop)
...
c     ----------------------------------------------------------------
      call madewdj_sp(nrslat,nknlat,mynod+1,num_atoms,
     >            rslat_x,rslat_y,rslat_z,rslatsq,
     >            knlat_x,knlat_y,knlat_z,knlatsq,
