...
c     cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      subroutine getstruc_sp(mynod,vbrar,omegbra,eta,
...
c     ----------------------------------------------------------------
      call getrscut_sp(eta,vbrar(1,1),vbrar(1,2),vbrar(1,3),
     >              rscut,nm1,nm2,nm3)
ctest
c     nm1=6
c     nm2=6
...
c     ----------------------------------------------------------------
      call lattice_sp(vbrar,rscut,nm1,nm2,nm3,
...
c     ----------------------------------------------------------------
      call getkncut_sp(eta,vbrak(1,1),vbrak(1,2),vbrak(1,3),
     >              kncut,nm1,nm2,nm3)
c     ----------------------------------------------------------------
c
c     ================================================================
...
c     ----------------------------------------------------------------
      call lattice_sp(vbrak,kncut,nm1,nm2,nm3,
