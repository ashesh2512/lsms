...
c     cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      subroutine getcor_sp(n_spin_pola,mtasa,
...
c     ================================================================
c     cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
!     subroutine getcor_sp(IN n_spin_pola,IN mtasa,
...
c
      ...
      integer    j
c
      real*4     r_mesh(iprpts),rtmp(0:iprpts)
      real*4     h
      real*4     xstart
      real*4     vr(iprpts,n_spin_pola)
      real*4     ec(ipcore,n_spin_pola)
      real*4     ztotss
      real*4     zsemss
      real*4     zcorss
      real*4     qsemmt
      ...
      real*4     mcpsc_mt
      real*4     mcpsc_ws
      real*4     ecorv(n_spin_pola)
      real*4     esemv(n_spin_pola)
      real*4     corden(iprpts,n_spin_pola)
      real*4     semcor(iprpts,n_spin_pola)
!     real*4     ebot
      real*4     wrk1(0:iprpts),wrk2(0:iprpts)
      real*4     zero
      real*4     tolch
!     real*4     etopcor
      real*4     work
...
!      etopcor=-10.0d+20
c     ----------------------------------------------------------------
      call zeroout_sp(corden,iprpts*n_spin_pola)
      call zeroout_sp(semcor,iprpts*n_spin_pola)
      call zeroout_sp(ecorv,n_spin_pola)
      call zeroout_sp(esemv,n_spin_pola)
c     ----------------------------------------------------------------
      qsemmt=zero
      qcormt=zero
      qsemws=zero
...
c        -------------------------------------------------------------
         call corslv_sp(jmt,jws,last,last2,h,r_mesh,vr(1,is),ztotss,
...
c           check the charges.........................................
c           ----------------------------------------------------------
c           call simpun_sp(r_mesh,semcor(1,is),iprpts,1,wrk1)
	    rtmp(0)=0.d0
	    wrk2(0)=0.d0
	    do j=1,last2
	    ...
	    enddo
            call newint_sp(last2+1,rtmp,wrk2,wrk1,3)
c           ----------------------------------------------------------
...
c           ----------------------------------------------------------
c           call simpun_sp(r_mesh,corden(1,is),iprpts,1,wrk1)
	    wrk2(0)=0.d0
	    do j=1,last2
