...
c     cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      subroutine deepst_sp(nqn,lqn,kqn,en,rv,r,rf,h,z,c,
...
c     ================================================================
c     ----------------------------------------------------------------
      call inws_sp(invp,nmax,rg,rf,rv,r,en,c,drg,drf,
...
!     write (*,*) "about to call NEWINT ",nmax
      call newint_sp(nmax+1,rtmp,tmp,qmp,1)
