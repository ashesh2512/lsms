...
c     cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      subroutine inws_sp(invp,nmax,rg,rf,rv,r,en,c,drg,drf,dk,dm,nws,
     >                imm,iprpts,ipdeq)
c     ================================================================
c
      implicit   none
...
c
      real*4     en,c,dk,dm
      real*4     r(iprpts),rv(iprpts),rg(iprpts),rf(iprpts)
      real*4     drf(ipdeq*2),drg(ipdeq*2)
      real*4     p,pq,dpr,dqr,er,emvoc,dq,dp
      real*4     zero,one,two,three,four
      real*4     ten,twtnth,half,thrqrt
      real*4     twntsvn,fhnd,fhd,sixhnd
      real*4     coef1,coef2
c
