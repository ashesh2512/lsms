...
c     cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      subroutine semcst_sp(nqn,lqn,kqn,en,rv,r,rf,h,z,c,
...
c     ----------------------------------------------------------------
 2    continue
      call outws_sp(invp,rg,rf,rv,r,en,c,drg,drf,elim,z,
...
c     ================================================================
c     ----------------------------------------------------------------
      call inwhnk_sp(invp,iprpts,rg,rf,rv,r,en,c,drg,drf,
     >     dk,dm,nlast,imm,iprpts,ipdeq)
c     ----------------------------------------------------------------
c     ================================================================
c     routine inws performs the inward integration
c     ----------------------------------------------------------------
!      call inws_sp (invp,nmax,rg,rf,rv,r,en,c,drg,drf,dk,dm,nws,imm,
!     >           iprpts,ipdeq)
c     ----------------------------------------------------------------
c
c     ================================================================
...
c     ================================================================
      ...
      enddo   
c     ----------------------------------------------------------------
      call newint_sp(iprpts+1,rtmp,tmp,qmp,1)
c     ----------------------------------------------------------------
