...
c     cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      subroutine scalarr_sp(nrelv,clight,l,
...
c
      ...
      integer    iprint
c
      real*4     r(iend),r_sph,rv_sph,drv_sph
      real*4     rv(iend)
      real*4     zed
      real*4     h,h24
      real*4     rvr,drvr
...
c     real*4     ylag
      ...
      real*4     one
c
      complex*8 f_sph,g_sph,df_sph,dg_sph
      complex*8 energy
      complex*8 prel
      complex*8 pnrel
      complex*8 g(iend)
      ...
      complex*8 dcl(4)
      complex*8 dsl(4)
      complex*8 ddcl,ddsl,dgpl,dfpl
      complex*8 bjl(2,iend)
      complex*8 bnl(2,iend)
      complex*8 bj(l+1)
      complex*8 bn(l+1)
      complex*8 djl(l+1)
      complex*8 dnl(l+1)
      complex*8 a1,a2,b1,b2
      complex*8 matom,sqrtm1
c
...
c     em = eoc2p1 - c2inv*rv(j)/r(j)
      call interp_sp(r,rv,i_out,r_sph,rv_sph,drv_sph,.false.)
      call cinterp_sp(r,f,i_out,r_sph,f_sph,df_sph,gpl)
      call cinterp_sp(r,g,i_out,r_sph,g_sph,dg_sph,gpl)
...
c     em = eoc2p1 - c2inv*rv(j)/r_sph
      ...
      emr= em*r_sph
c     -----------------------------------------------------------------
        call ricbes_sp(l+1,pr,bj,bn,djl,dnl)
c     -----------------------------------------------------------------
c     =================================================================
...
c
c     cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      subroutine scalari_sp(nrelv,clight,l,
     >                  bjl,bnl,bj,bn,djl,dnl,g,f,gpl,fpl,
     >                  tandel,matom,
     >                  energy,prel,pnrel,
     >                  rv,r,h,jmt,iend,icmax,
...
c	 call interp_sp(r,rv,506,r(j),rvr,drvr,.false.)
c	 call interp_sp(r,rv,i_out,r(j),rvr,drvr,.false.)
