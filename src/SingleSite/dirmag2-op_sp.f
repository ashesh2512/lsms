      subroutine dirmago2op_sp(socsc,e,l,my,vr,bspr,bopr,
...
c
      ...
      complex*8 e,p1,q1,p2,q2,pp1,qp1,pp2,qp2
      complex*8 p1n,q1n,k11,k12,k13,k14,m11,m12,m13,m14       
      complex*8 p2n,q2n,k21,k22,k23,k24,m21,m22,m23,m24       
      complex*8 p1sum,q1sum,p10,q10,p11,q11,pp1np1,qp1np1          
      complex*8 p2sum,q2sum,p20,q20,p21,q21,pp2np1,qp2np1          
      complex*8 g,gp,f
c
...
c
      call brmat_sp(l,my,ns,bspr,bopr,ba11,ba12,ba22,bb11,bb22,iprpts)
c
      do ii=1,2
      if(ii.eq.2) go to 40
c
...
c
      r=dexp(xnot)
      call dmag2op_sp(pp1(1),qp1(1),pp2(1),qp2(1),
     >           p1(1),q1(1),p2(1),q2(1),
...
c
        ...
        p2n=p2(n)
        q2n=q2(n)
        call dmag2op_sp(k11,m11,k21,m21,p1n,q1n,p2n,q2n,
     >             xk1,xk2,facl1,facl2,cin,e,rn,
     >             vrn,ba11n,ba12n,ba22n,bb11n,bb22n)
c
        call dmag2op_sp(k12,m12,k22,m22,
...
c
        call dmag2op_sp(k13,m13,k23,m23,
     >             p1n+dx2*k12,q1n+dx2*m12,p2n+dx2*k22,q2n+dx2*m22,
     >             xk1,xk2,facl1,facl2,cin,e,rmid,
     >             vrmid,ba11mid,ba12mid,ba22mid,bb11mid,bb22mid)
c
        call dmag2op_sp(k14,m14,k24,m24,
...
c
        ...
        call dmag2op_sp(pp1(n+1),qp1(n+1),pp2(n+1),qp2(n+1),
...
c
        do nit=1,nitmax
c
          call dmag2op_sp(pp1np1,qp1np1,pp2np1,qp2np1,
     >               p10,q10,p20,q20,
     >               xk1,xk2,facl1,facl2,cin,e,r,
...
c
      ...
      subroutine dirmagi2op_sp(socsc,e,l,my,vr,bspr,bopr,
     >                    dx,xnot,rs,ns,g,f,gp,iprpts)
c
      implicit real*4(a-h,o-z)
!     include '../param.h'
...
c
      ...
      complex*8 e,psq,pe
      complex*8 p1,q1,p2,q2,pp1,qp1,pp2,qp2
      complex*8 p1n,q1n,k11,k12,k13,k14,m11,m12,m13,m14       
      complex*8 p2n,q2n,k21,k22,k23,k24,m21,m22,m23,m24       
      complex*8 p1sum,q1sum,p10,q10,p11,q11,pp1nm1,qp1nm1          
      complex*8 p2sum,q2sum,p20,q20,p21,q21,pp2nm1,qp2nm1          
      complex*8 g,gp,f
      complex*8 fb(0:5),fn(0:5),fh(0:5)
c
      dimension vr(iprpts),bspr(iprpts),bopr(iprpts,2)
...
c     get combined effective fields
c
      call brmat_sp(l,my,nlag,bsprlag,boprlag,ba11,ba12,ba22,bb11,bb22,
     >           iprpts)
c
      psq=e+e*e*cin
      pe=cdsqrt(psq)
...
c
      x=xs+nout*dx
      r=dexp(x)
      call csbf_sp(l+1,pe,r,fb,fn,fh)
      n=ns+nout
c
      if(ii.eq.2) go to 40
      p1(n) = r*fb(l)
      ...
      p2(n) = 0.d0             
      q2(n) = 0.d0                     
      call dmag2op_sp(pp1(n),qp1(n),pp2(n),qp2(n),
     >           p1(n),q1(n),p2(n),q2(n),
     >           xk1,xk2,facl1,facl2,cin,e,r,
...
c
        do nit=1,nitmax
c
          call dmag2op_sp(pp1nm1,qp1nm1,pp2nm1,qp2nm1,
     >               p10,q10,p20,q20,
     >               xk1,xk2,facl1,facl2,cin,e,r,
     >               vrc,ba11c,ba12c,ba22c,bb11c,bb22c)
...
c
      ...
      subroutine dmag2op_sp(pp1,qp1,pp2,qp2,p1,q1,p2,q2,
     >                 xk1,xk2,facl1,facl2,cin,e,r,
     >                 vr,ba11,ba12,ba22,bb11,bb22)
c
      implicit real*4 (a-h,o-z)
      complex*8 pp1,qp1,pp2,qp2,p1,q1,p2,q2,e,tr,sr1,sr2
c
      tr=r*e-vr
