      subroutine dirmago1op_sp(socsc,e,l,my,vr,bspr,bopr,
...
c
      ...
      real*4 socsc,vr,bspr,bopr,dx,xnot,rs
      complex*8 e,p,q,pp,qp
      complex*8 pn,qn,k1,k2,k3,k4,m1,m2,m3,m4
      complex*8 psum,qsum,p0,q0,p1,q1,ppnp1,qpnp1
      complex*8 g,gp,f
c
      real*4 x,xk,xkap,xl,vrnp1,vrc,vrmid,vrn
      real*4 r,rn,rmid,u,rnp1,facl,hoc,test
      real*4 ba11,ba12,ba22,bb11,bb22
      real*4 bb22c,bb22n,bb22np1,bb22mid
      real*4 ba22c,ba22n,ba22np1,ba22mid
      real*4 c,cin,dkoef1,dkoef2,dx2
...
c
      r=dexp(xnot)
      call dmag1op_sp(pp(1),qp(1),p(1),q(1),
...
c
        pn=p(n)
        qn=q(n)
        call dmag1op_sp(k1,m1,pn,qn,
     >             xk,facl,cin,e,rn,vrn,ba22n,bb22n)
c
        call dmag1op_sp(k2,m2,pn+dx2*k1,qn+dx2*m1,
     >             xk,facl,cin,e,rmid,vrmid,ba22mid,bb22mid)
c
        call dmag1op_sp(k3,m3,pn+dx2*k2,qn+dx2*m2,
     >             xk,facl,cin,e,rmid,vrmid,ba22mid,bb22mid)
c
        call dmag1op_sp(k4,m4,pn+dx*k3,qn+dx*m3,
     >             xk,facl,cin,e,rnp1,vrnp1,ba22np1,bb22np1)
c
        p(n+1)=pn+dx*(k1+2.d0*k2+2.d0*k3+k4)/6.d0
        q(n+1)=qn+dx*(m1+2.d0*m2+2.d0*m3+m4)/6.d0
        call dmag1op_sp(pp(n+1),qp(n+1),p(n+1),q(n+1),    
     >             xk,facl,cin,e,rnp1,vrnp1,ba22np1,bb22np1)
c
      end do                 
c
...
c
        do nit=1,nitmax
c
          call dmag1op_sp(ppnp1,qpnp1,p0,q0,
...
c
      ...
      subroutine dirmagi1op_sp(socsc,e,l,my,vr,bspr,bopr,
     >                    dx,xnot,rs,ns,g,f,gp,iprpts)
c
      implicit real*4(a-h,o-z)
!     include '../param.h'
...
c
      ...
      complex*8 p,q,pp,qp
      complex*8 pn,qn,k1,k2,k3,k4,m1,m2,m3,m4
      complex*8 psum,qsum,p0,q0,p1,q1,ppnm1,qpnm1
      complex*8 g,gp,f
...
c
      ...
      call dmag1op_sp(pp(n),qp(n),p(n),q(n),
...
c
        do nit=1,nitmax
c
          call dmag1op_sp(ppnm1,qpnm1,p0,q0,
     >               xk,facl,cin,e,r,vrc,ba22c,bb22c)
...
c
      ...
      subroutine dmag1op_sp(pp,qp,p,q,xk,facl,cin,e,r,vr,ba22,bb22)
c
      implicit real*4 (a-h,o-z)
      complex*8 pp,qp,p,q,e,tr,sr
c
      tr=r*e-vr
