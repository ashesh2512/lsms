...
c     ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      subroutine single_scatterer_nonrel_sp(nrelv,clight,lmax,kkrsz,
     >                       energy,prel,pnrel,
     >                       vr,rr,h,jmt,jws,
     >                       tmat,matom,
     >                       zlr,jlr,
...
!      write(6,*) "Inside single_scatterer_nonrel. Before semrel."
      call semrel_sp(nrelv,clight,lmax,
     >            energy,prel,pnrel,
     >            matom,zlr,jlr,
     >            h,jmt,jws,rr,vr,
c    >            h,506,506,rr,vr,
...
c     -----------------------------------------------------------------
      call zeroout_sp(tmat,2*kkrsz*kkrsz)
c     -----------------------------------------------------------------
      lm=0
      do l=0,lmax
         do m=-l,l
         ...
         enddo
c        --------------------------------------------------------------
c        call caxpy(jws,-tmat(lm,lm),zlr(1,l),1,jlr(1,l),1)
c        --------------------------------------------------------------
      enddo
c
c     =================================================================
