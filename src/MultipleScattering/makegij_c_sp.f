c     cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      subroutine makegij_sp(lmaxi,kkri,lmaxj,kkrj,
...
c
      real*4     rij(3)
      real*4     sinmp(0:lmaxi+lmaxj)
      real*4     cosmp(0:lmaxi+lmaxj)
      real*4     clm(ndlm)
      real*4     plm(ndlm)
!     original definition of cgnt in LSMS_1
!     real*4     cgnt(lmax+1,kkrsz,kkrsz)
      real*4     cgnt(lmax_cg+1,(lmax_cg+1)**2,(lmax_cg+1)**2)
      real*4     pi4
      real*4     rmag
      real*4     pmag
      real*4     costheta
...
c
      complex*8 prel
      complex*8 ilp1(0:lmaxi+lmaxj)
!     original definition of illp in LSMS_1
!     complex*8 illp(kkrsz,kkrsz)
      complex*8 illp((lmax+1)**2,kkrsz)
      complex*8 hfn(0:lmaxi+lmaxj)
      complex*8 dlm(ndlj)
      complex*8 gij(kkri,kkrj)
      complex*8 z
      complex*8 fac
      complex*8 sqrtm1
      complex*8 czero
...
! meis: changed to normalized associated Legendre functions
      call plm_normalized_sp(lend,costheta,plm)
c     -----------------------------------------------------------------
c     =================================================================
...
c     calculate g(R_ij)...............................................
c     ----------------------------------------------------------------
!     call zeroout_sp(gij,2*kkri*kkrj)
      gij=0.0d0
c     ----------------------------------------------------------------
c     ================================================================
c     loop over l1,m1............................................
