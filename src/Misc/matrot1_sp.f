      subroutine matrot1_sp(r0,r1,lmax,dmat,dmatp)
! =====================
!
...
!
      ...
      complex*8 dmatp(2*(lmax+1)*(lmax+1),2*(lmax+1)*(lmax+1))
      complex*8 cmat(2*(lmax+1)*(lmax+1),2*(lmax+1)*(lmax+1))
      complex*8 d(2*lmax+2,2*lmax+2),dz(3)
!
!     common/test/itest
!
      pi=4.d0*datan(1.d0)
