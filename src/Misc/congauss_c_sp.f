...
c     cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      subroutine congauss_sp(ebot,etop,eibot,egrd,dele1,ngauss,nume,
...
c
      ...
      real*4     one
c
      complex*8 egrd(ipepts)
      complex*8 dele1(ipepts)
      complex*8 zzero
      complex*8 ihalfpi
      complex*8 czero
      complex*8 cone
...
c     set nume equal to number of points on grid i.e. ngauss..........
      nume=ngauss
c     ----------------------------------------------------------------
      call gauss_legendre_points_sp(-one,one,xgs,wgs,ngauss)
c     ----------------------------------------------------------------
c
c     ================================================================
