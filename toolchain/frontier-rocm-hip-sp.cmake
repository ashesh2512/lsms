...
set(CMAKE_SP ON CACHE BOOL "Precision Setting")

if (NOT CMAKE_C_FLAGS MATCHES "-Wdouble-promotion")
  set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -Wdouble-promotion -O0" CACHE STRING "Append C compiler flags")
endif()

if (NOT CMAKE_CXX_FLAGS MATCHES "-Wdouble-promotion")
  set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -Wdouble-promotion -O0" CACHE STRING "Append C++ compiler flags")
endif()
